	...
	return el({
		...
		el({
			...
			el({
				...
				c: a[56],
				d: {
					style:`${ a[13] }:${ a[46] }(0,0,0,.8);${ a[17] }-${ a[42] }:6${ a[41] };color:${ a[46] }(255,255,255,.8);${ a[21] }:${ a[27] };${ a[31] }:0 0 12${ a[41] } 0;${ a[37] }:8${ a[41] } 48${ a[41] } 8${ a[41] } 32${ a[41] };${ a[52] }-${ a[11] }:${ a[18] };`
				},
				e: { mousedown: a[3] }
			}) [a[38]],
		c: 'x',
		...
		d: {
			style: `${ a[55] }:${ a[57] }${ a[41] };${ a[28] }:${ a[58] }${ a[41] };${ a[13] }:${ a[46] }(255,255,255,.8);${ a[17] }:1${ a[41] } solid ${ a[46] }(0,0,0,.1);${ a[17] }-${ a[41] }:8${ a[41] };${ a[37] }:8${ a[41] };min-${ a[55] }:80${ a[41] };min-${ a[28] }:48${ a[41] };${ a[45] }:${ a[15] };${ a[36] }:${ a[47] };`
		}
	})
}
